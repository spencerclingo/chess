...
public class EscapeSequences {
    ...
    public static final String SET_TEXT_NOT_BOLD = UNICODE_ESCAPE + "[0m";
    ...
    public static final String SET_BG_COLOR_DARK_BLUE = SET_BG_COLOR + "21m";
    public static final String SET_BG_COLOR_LIGHT_BLUE = SET_BG_COLOR + "111m";
